# Homepage Component Split Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Split `pages/index.js` into focused single-purpose files following the `pages/resume/` pattern, with CSS moved to `styles/home.css`.

**Architecture:** Pure structural refactor — no behavior or visual changes. All code moves verbatim; only import paths change. Components are extracted in dependency order (data → animations → sections → page).

**Tech Stack:** Next.js (Pages Router), React, FontAwesome, inline styles + Tailwind utilities, WebGL (AuroraBackground), Canvas 2D (NeuralBackground).
...
|--------|------|----------------|
| Create | `styles/home.css` | All CSS from the `<style>` JSX block |
| Create | `data/home-data.js` | `techStack`, `projects`, `contactLinks` arrays |
| Create | `pages/home/AuroraBackground.js` | WebGL two-canvas helix ribbon animation |
| Create | `pages/home/NeuralBackground.js` | Canvas 3D node graph with signals |
| Create | `pages/home/Nav.js` | Navigation bar |
| Create | `pages/home/WorkCards.js` | Selected work grid |
| Create | `pages/home/Footer.js` | Contact links + copyright |
| Create | `pages/home/Hero.js` | Hero section (photo, name, bio, CTAs, mesh blobs) |
| Modify | `pages/index.js` | Composition only: Head, scroll bar, ambient glow, imports |

---

### Task 1: Create `styles/home.css`

**Files:**
- Create: `styles/home.css`

- [ ] **Step 1: Create `styles/home.css` with the full CSS content**
...
```bash
git add styles/home.css
git commit -m "feat: extract homepage CSS to styles/home.css"
```

---

### Task 2: Create `data/home-data.js`

**Files:**
- Create: `data/home-data.js`

- [ ] **Step 1: Create `data/home-data.js`**
...
```bash
git add data/home-data.js
git commit -m "feat: extract homepage data to data/home-data.js"
```

---

### Task 3: Create `pages/home/AuroraBackground.js`

**Files:**
- Create: `pages/home/AuroraBackground.js`
...
- [ ] **Step 2: Create `pages/home/AuroraBackground.js`**
...
```bash
git add pages/home/AuroraBackground.js
git commit -m "feat: extract AuroraBackground to pages/home/AuroraBackground.js"
```

---

### Task 4: Create `pages/home/NeuralBackground.js`

**Files:**
- Create: `pages/home/NeuralBackground.js`

- [ ] **Step 1: Create `pages/home/NeuralBackground.js`**
...
```bash
git add pages/home/NeuralBackground.js
git commit -m "feat: extract NeuralBackground to pages/home/NeuralBackground.js"
```

---

### Task 5: Create `pages/home/Nav.js`

**Files:**
- Create: `pages/home/Nav.js`

- [ ] **Step 1: Create `pages/home/Nav.js`**
...
```bash
git add pages/home/Nav.js
git commit -m "feat: extract Nav to pages/home/Nav.js"
```

---

### Task 6: Create `pages/home/WorkCards.js`

**Files:**
- Create: `pages/home/WorkCards.js`

- [ ] **Step 1: Create `pages/home/WorkCards.js`**
...
```bash
git add pages/home/WorkCards.js
git commit -m "feat: extract WorkCards to pages/home/WorkCards.js"
```

---

### Task 7: Create `pages/home/Footer.js`

**Files:**
- Create: `pages/home/Footer.js`

- [ ] **Step 1: Create `pages/home/Footer.js`**
...
```bash
git add pages/home/Footer.js
git commit -m "feat: extract Footer to pages/home/Footer.js"
```

---

### Task 8: Create `pages/home/Hero.js`

**Files:**
- Create: `pages/home/Hero.js`

- [ ] **Step 1: Create `pages/home/Hero.js`**
...
```bash
git add pages/home/Hero.js
git commit -m "feat: extract Hero to pages/home/Hero.js"
```

---

### Task 9: Rewrite `pages/index.js`

**Files:**
- Modify: `pages/index.js`

- [ ] **Step 1: Replace `pages/index.js` with the composition-only version**
...
- [ ] **Step 2: Verify the page loads correctly in the browser**

Open `http://localhost:3000` and confirm:
- Aurora ribbons animate in the hero
- Neural node graph animates over the hero
- Photo, name, bio, and CTA render correctly
- Work cards animate in on scroll
- Footer contact links are present
